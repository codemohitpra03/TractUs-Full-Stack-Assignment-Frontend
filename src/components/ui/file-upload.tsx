...
import { CONTRACT_TYPE, ContractType } from "@/types";
...
export const FileUpload = ({
  ...
  const handleFileChange = (newFiles: File[]) => {
    const fileType = newFiles[0].name.split(".").pop()?.toLowerCase();
    if ((contractType === CONTRACT_TYPE.TEXT && fileType === "txt") || (contractType === CONTRACT_TYPE.JSON && fileType === "json")) {
